(function () {
    ...
    angular.module('archivedRequests').registerCtrl('archivedDeliveryDetailsController', archivedDeliveryDetailsController);
    archivedDeliveryDetailsController.$inject = ['$scope', 'archivedRequestsService',
        '$state', 'errorHandlingService', 'packageService', 'deliveryRequestService'];
    function archivedDeliveryDetailsController($scope, archivedRequestsService,
            $state, errorHandlingService, packageService, deliveryRequestService) {
        ...
        $scope.getPackageDetails = function () {
            ...
            deliveryRequestService.getStatusHistory($scope.requestId).
        ...
        $scope.getRequestDetails = function () {
            console.log($scope.requestId);
            archivedRequestsService.getRequestById($scope.requestId).
