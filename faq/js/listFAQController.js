        ...
        $scope.deletePopup = function (entity) {
            ...
            function callbackFn(result) {
                if (!result) {
                    ...
                    popup.show("sm", 'faq/html/deleteFAQ.html', 'DeleteFAQController', entity)
                            .then(okCallBackFn);
...
//            }
            ...
            popup.show("lg", 'faq/html/editFAQ.html', 'EditFAQController',entity)
                    .then(editCallBackFn);
        ...
        $scope.addPopup = function () {
            popup.show("lg", 'faq/html/addFAQ.html', 'AddFAQController')
                    .then(addCallBackFn);
