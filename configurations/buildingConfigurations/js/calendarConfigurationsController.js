(function () {
    "use strict";
    angular.module('buildingConfiguration').registerCtrl('CalendarConfigurationController', CalendarConfigurationController);
    CalendarConfigurationController.$inject = ['configurationService', '$window',
        '$scope', '$filter', 'errorHandlingService', 'popup',
        'authorizationService', 'userInfoService', 'buildingService'];
    function CalendarConfigurationController(configurationService, $window,
            $scope, $filter, errorHandlingService, popup,
            authorizationService, userInfoService, buildingService) {
        ...
        $scope.$parent.childContollersInits[2] = $scope.childInit;
    }
}());
